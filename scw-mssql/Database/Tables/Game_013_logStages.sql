CREATE TABLE [dbo].[Game_013_logStages]
(
	...
	CONSTRAINT FK_Game_013_logStages_Game_013_LogID FOREIGN KEY (Game_013_logID) REFERENCES [dbo].[Game_013_log] (Game_013_logID)
